      ...
      <div className="w-full max-w-4xl mx-auto text-center">
        ...
        >
          <p className="text-lg leading-relaxed">
            ...
            infrastructure for M365 Copilot. Currently, on a platform team at
            Microsoft.
          </p>
        </GradientCard>
        ...
        <div className="relative flex h-[200px] w-[300px] flex-col items-center justify-center rounded-md bg-white-200 px-5 py-2">
          <BorderTrail
            style={{
              boxShadow:
